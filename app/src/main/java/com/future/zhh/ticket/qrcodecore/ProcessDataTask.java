...
public class ProcessDataTask extends AsyncTask<Void, Void, String> {
    ...
    private byte[] mData;
    private cn.bingoogolapple.qrcode.core.ProcessDataTask.Delegate mDelegate;
    private int orientation;

    public ProcessDataTask(Camera camera, byte[] data, cn.bingoogolapple.qrcode.core.ProcessDataTask.Delegate delegate, int orientation) {
        mCamera = camera;
        mData = data;
        mDelegate = delegate;
    ...
    protected String doInBackground(Void... params) {
        ...
        if (orientation == cn.bingoogolapple.qrcode.core.BGAQRCodeUtil.ORIENTATION_PORTRAIT) {
