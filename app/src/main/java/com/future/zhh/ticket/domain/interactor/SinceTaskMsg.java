...
public class SinceTaskMsg extends Case {
    private CommonRepository repository;
    private String orderID;
    @Inject
    public SinceTaskMsg(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
    ...
    protected Observable buildCaseObservable() {
        return repository.sinceTaskMsg(orderID);
    }
}
