...
public abstract class QRCodeView extends RelativeLayout implements Camera.PreviewCallback, cn.bingoogolapple.qrcode.core.ProcessDataTask.Delegate {
    protected Camera mCamera;
    protected cn.bingoogolapple.qrcode.core.CameraPreview mPreview;
    protected ScanBoxView mScanBoxView;
    protected cn.bingoogolapple.qrcode.core.QRCodeView.Delegate mDelegate;
    protected Handler mHandler;
    protected boolean mSpotAble = false;
    protected cn.bingoogolapple.qrcode.core.ProcessDataTask mProcessDataTask;
    ...
    private void initView(Context context, AttributeSet attrs) {
        mPreview = new cn.bingoogolapple.qrcode.core.CameraPreview(getContext());
     ...
     */
    public void setDelegate(cn.bingoogolapple.qrcode.core.QRCodeView.Delegate delegate) {
        mDelegate = delegate;
    }
