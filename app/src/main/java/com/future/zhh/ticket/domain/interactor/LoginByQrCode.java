...
public class LoginByQrCode extends Case {
    private CommonRepository repository;
    private String userQrCode;
    @Inject
    public LoginByQrCode(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
                         CommonRepository repository) {
        super(threadExecutor, postExecutionThread);
        this.repository = repository;
    }
    public void setData(String userQrCode){
    ...
    protected Observable buildCaseObservable() {
        return repository.loginByQrCode(userQrCode);
    }
}
