...
import com.future.zhh.ticket.presentation.view.activities.CheckLogActivity;
...
public interface CheckLogActivityComponent extends ActivityComponent{
    void inject(CheckLogActivity checkLogActivity);
    void inject(CheckLogFragment checkLogFragment);
}
