...
public class SinceOfReclaim extends Case {
    ...
    @Inject
    public SinceOfReclaim(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
    ...
    protected Observable buildCaseObservable() {
        return repository.sinceOfReclaim(gasMsg,orderID,id);
    }
}
